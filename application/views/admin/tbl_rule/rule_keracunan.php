                      ...
                      <tbody>
                        ...
                        <?php foreach ($keracunan as $k) : ?>
                          <tr>
                            ...
                            <td>
                              <a style="padding: 1em 1.8em 1em;" href="" class="buttonku buttonku--moemaedt buttonku--text-thick buttonku--text-upper buttonku--size-s" data-toggle="modal" data-target="#editRuleModal<?= $k['id']; ?>">ubah</a>
                              <script>
                              ...
                              <a href="<?= base_url('rule/hapusRule/') . $k['id']; ?>" style="padding: 1em 1.2em 1em;" class="tombol-hapus buttonku buttonku--moemadel buttonku--text-thick buttonku--text-upper buttonku--size-s">hapus</a>
                            </td>
                          </tr>
                          <?php $i++; ?>
                        <?php endforeach; ?>
